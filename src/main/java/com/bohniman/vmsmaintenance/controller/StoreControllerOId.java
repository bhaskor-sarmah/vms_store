...
// public ModelAndView pageOrderDetail(ModelAndView mv, @PathVariable("orderId")
// Long orderId) {
...
// @Valid @ModelAttribute MasterVehicleInventory masterVehicleInventory,
...
// @ResponseBody
// public ResponseEntity<JsonResponse>
// deleteInventory(@PathVariable("inventoryId") Long inventoryId) {
// JsonResponse res = new JsonResponse();
...
// @ResponseBody
// public MasterVehicleInventory getInventoryById(@PathVariable("inventoryId")
// Long inventoryId) {
...
// @ResponseBody
// public MasterVehicle getVehicleById(@PathVariable("vehicleId") Long
// vehicleId) {
...
// @ResponseBody
// public List<MasterVehicle> getVehicleByNumber(@RequestParam("vehicleNumber")
// String vehicleNo,
...
// // public ModelAndView openJobCard(ModelAndView mv,
...
// // public ModelAndView viewJobCard(ModelAndView mv,
// @PathVariable("vehicleId")
// // Long vehicleId) {
...
// List<MasterVehicleCategory> vehicleCategoryList =
// storeService.getAllVehicleCategoryList();
// mv.addObject("vehicleCategoryList", vehicleCategoryList);
// List<MasterVehicleType> vehicleTypeList =
// storeService.getAllVehicleTypeList();
...
// @ResponseBody
// public ResponseEntity<JsonResponse> addVehicle(@Valid @ModelAttribute
...
// if (vehicleExists) {
// bindingResult.rejectValue("vehicleRegistrationNo",
// "error.vehicleRegistrationNo",
// " * Vehicle Already Exists");
// }
// }
// // FOR EDIT
// else {
// MasterVehicle editVehicle =
// storeService.getVehicleById(masterVehicle.getId());
// if (!Objects.equals(editVehicle, null) &&
// !Objects.equals(masterVehicle.getVehicleRegistrationNo(),
...
// @ResponseBody
// public ResponseEntity<JsonResponse> searchVehicle(@RequestParam("searchType")
// Long searchType,
...
// @ResponseBody
// public ResponseEntity<JsonResponse> deleteVehicle(@PathVariable("vehicleId")
// Long vehicleId) {
// JsonResponse res = new JsonResponse();
...
// public ResponseEntity<JsonResponse> getSearchVendorItem(@RequestParam(value =
...
// @ResponseBody
// public ResponseEntity<JsonResponse> openJobCard(@Valid @ModelAttribute
...
// public ModelAndView viewJobCard(ModelAndView mv, @PathVariable("jobCardId")
// Long jobCardId) {
// mv = new ModelAndView("store/view_job_card");
...
// @ResponseBody
// public ResponseEntity<JsonResponse> openJobCard(@RequestParam("jobCardId")
// Long jobCardId,
...
// public ModelAndView jobCardHome(ModelAndView mv, @RequestParam
...
// List<TransVehicleJobCard> jobCards =
// storeService.getJobCardsByDateRange(dateFrom, dateTo);
